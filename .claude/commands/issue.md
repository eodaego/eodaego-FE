...
판단된 타입에 맞는 템플릿을 사용하여 **제목 + 본문**을 출력하고, `docs/issues/` 폴더에 파일로 저장합니다.

#### 파일 저장 규칙

- **위치**: `docs/issues/` 디렉토리 (없으면 자동 생성)
- **파일명**: `[YYYYMMDD]_[타입]_[간단한설명].md`
  - 예시: `20260415_버그_로그인_안됨.md`
  - 예시: `20260415_기능추가_프로필_이미지_업로드.md`
  - 날짜: 현재 날짜 (YYYYMMDD)
  - 타입: `버그`, `기능추가`, `기능개선`, `기능요청`, `디자인`, `시험요청`
