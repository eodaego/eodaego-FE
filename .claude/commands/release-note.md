...
- 출력: `docs/release-note/vX.Y.Z.md` 파일로 저장
- 톤: **간결하고 담백하게**. 사실만
...
1. `docs/release-note/` 폴더가 없으면 생성
2. `docs/release-note/v{VERSION}.md` 경로에 저장
...
### 출력 (`docs/release-note/v1.4.10.md`)
...
- "콘솔에 붙여넣을 때는 채팅이 아니라 저장된 파일(`docs/release-note/vX.Y.Z.md`)을 열어 복사하세요"라고 한 줄 덧붙인다.
