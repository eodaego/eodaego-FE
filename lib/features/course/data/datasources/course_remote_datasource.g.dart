...
class _CourseRemoteDataSource implements CourseRemoteDataSource {
  ...
  Future<CourseFavoriteListModel> getFavorites(String? sort) async {
    ...
    final _options = _setStreamType<CourseFavoriteListModel>(
    ...
    late CourseFavoriteListModel _value;
    try {
      _value = CourseFavoriteListModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
